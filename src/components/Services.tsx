...
export function Services({ onGetQuote }: ServicesProps) {
  const services = [
    {
      name: 'Countertop',
      image: 'https://bisque-chamois-732958.hostingersite.com/wp-content/uploads/2025/11/Countertop.jpg',
      description: (
        <>
    ...
    {
      name: 'Cabinet',
      image: 'https://bisque-chamois-732958.hostingersite.com/wp-content/uploads/2025/11/Cabinet.jpg',
      description: (
        <>
    ...
    {
      name: 'Tile',
      image: 'https://bisque-chamois-732958.hostingersite.com/wp-content/uploads/2025/11/Tile.jpg',
      description: (
        <>
  ...
  const materials = [
    {
      name: 'Granite',
      image: 'https://bisque-chamois-732958.hostingersite.com/wp-content/uploads/2025/11/granite.jpeg',
    },
    {
      name: 'Quartz',
      image: 'https://bisque-chamois-732958.hostingersite.com/wp-content/uploads/2025/11/quarts.jpg',
    },
    {
      name: 'Marble',
      image: 'https://bisque-chamois-732958.hostingersite.com/wp-content/uploads/2025/11/marble.jpg',
    },
  ];
